<div class="row">
	<ul class="nav nav-tabs">
	  ...
	  <li class="active"><a data-toggle="tab" class="btn btn-sm btn-success tabpill" href="#home" style="border-radius:0px; color:#272822" id="toexcel1">Form 1 (Main Report - F1)</a></li>
	  <li><a data-toggle="tab" href="#home2" class="btn btn-sm btn-success tabpill" style="border-radius:0px; color:#272822" id="toexcel2">Form 1.2 (Damages and Assistance - F2)</a></li>
	  <li><a data-toggle="tab" href="#evacuation_stats" class="btn btn-sm btn-success tabpill" style="border-radius:0px; color:#272822" id="toexcel3">Form 2 (Evacuations - F3)</a></li>
	  <li><a data-toggle="tab" href="#evacuation_stats_outside" class="btn btn-sm btn-success tabpill" style="border-radius:0px; color:#272822" id="toexcel4">Form 3 (Outside Evacuations - F4)</a></li>
	  <li><a data-toggle="tab" href="#casualties" class="btn btn-sm btn-success tabpill" style="border-radius:0px; color:#272822" id="toexcel5">Form 4 (Casualties - F5)</a></li>
	  <li><a data-toggle="tab" href="#damagesperbrgy" class="btn btn-sm btn-success tabpill" style="border-radius:0px; color:#272822" id="toexcel7">Damages and Assistance per Barangay - F7</a></li>
	  <li><a data-toggle="tab" href="#assistance" class="btn btn-sm btn-success tabpill" style="border-radius:0px; color:#272822" id="toexcel6">Food and Non-Food Assistance - F6</a></li>
	</ul>
	...
	<div class="tab-content">
		...
		<div class="form-group col-md-12">
			<button type="button" class="btn btn-success btn-xs" id="saveasnewrecord"><i class="fa fa-plus-circle"></i> Save as new Record and Update Data (Ctrl+S)</button>
			<button type="button" class="btn btn-primary btn-xs" id="addfamiec"><i class="fa fa-plus-circle"></i> Add Affected Families Inside EC (Ctrl+I)</button>
			<button type="button" class="btn btn-primary btn-xs" id="adddamass"><i class="fa fa-plus-circle"></i> Add Damages and Cost of Assistance [P/MLGU] (Ctrl+D)</button>
			<button type="button" class="btn btn-primary btn-xs" id="addfamoec"><i class="fa fa-plus-circle"></i> Add Affected Families Outside EC (Ctrl+Q)</button>
			<button type="button" class="btn btn-danger btn-xs" id="addcasualtybtn"><i class="fa fa-plus-circle"></i> Add Casualties (Ctrl+X)</button>
			<button type="button" class="btn btn-default btn-xs" id="exporttoexcel"><label style="border:1px solid #006400; position:absolute; width:30px; height:38px; margin-top:-9px; margin-left:-3px; background-color:#006400; color:#fff;"><i class="fa fa-file-excel-o" style="margin-top:11px; margin-left:3px; cursor:pointer"></i></label>          Export to Excel (Ctrl+E)
			</button>
	  ...
	  <div id="home" class="tab-pane fade in active">
	  		<div class="col-md-4 pull-right" style="color:#000; font-weight: bold; margin-top: -20px; font-size: 15px">
	  				Number of affected municipalities: <label id="count_allmunis"></label>
	  		</div>
	    	<div class="col-md-12" style="border:1px solid gray;" id="tbl_masterquery">
		    	<table style="width:100%;">
		    		<thead>
		    			<tr>
		    				<th style="text-align:center; font-weight:lighter; color: #000" colspan="18">Department of Social Welfare and Development</th>
		    			</tr>
		    			<tr>
		    				<th style="text-align:center; color: #000" colspan="18"><b>DISASTER RESPONSE, OPERATIONS, MONITORING AND INFORMATION CENTER</b></th>
		    			</tr>
		    			<tr>
		    				<th style="text-align:center; font-weight:lighter; color: #000" colspan="18">Batasan Pambansa Complex, Constitution Hills</th>
		    			</tr>
		    			<tr>
		    				<th style="text-align:center; font-weight:lighter; color: #000" colspan="18">Quezon City</th>
		    			</tr>
		    			<tr>
		    				<th style="text-align:center; font-weight:lighter; color: #000" colspan="18"><br></th>
		    			</tr>
		    			<tr>
		    				<th style="text-align:center; color: #000" colspan="18"><b>STATUS OF DISASTER OPERATIONS</b></th>
		    			</tr>
		    			<tr>
		    				<th style="text-align:center; font-weight:lighter; color: #000" id="asofdate" colspan="18">As of: </th>
		    			</tr>
		    			<tr>
		    				<th style="text-align:center; font-weight:lighter; color: #000" id="asoftime" colspan="18">Time: </th>
		    			</tr>
		    			<tr>
		    				<th style="text-align:left; font-weight:lighter; color: #000" colspan="18">Region:<b> CARAGA </b> </th>
		    			</tr>
		    			<tr>
		    				<th style="text-align:left; font-weight:lighter; color: #000" id="disastertype" colspan="18"></th>
		    			</tr>
		    			<tr>
		    				<th style="text-align:left; font-weight:lighter; color: #000" id="disasterdate" colspan="18"></th>
		    			</tr>
		    			<tr>
							<td rowspan="4" style="text-align:center; border:1px solid #000; background-color: #808080; color: #000">
								<b>AFFECTED AREAS</b>
							</td>
							<td rowspan="4" colspan="3" style="text-align:center; border:1px solid #000; background-color: #808080; color: #000">
								<b>NUMBER OF AFFECTED</b>
							</td>
							<td rowspan="4" colspan="2" style="text-align:center; border:1px solid #000; background-color: #808080; color: #000">
								<b>NUMBER OF ECs</b>
							</td>
						</tr>
						<tr>
							<td colspan="12" style="text-align:center; width:60%; border:1px solid #000; background-color: #808080; color: #000">
								<b>TOTAL NUMBER SERVED</b>
							</td>
						</tr>
						<tr>
							<td colspan="4" style="text-align:center; border:1px solid #000; background-color: #808080; color: #000">
								<b>INSIDE EC</b>
							</td>
							<td colspan="4" style="text-align:center; border:1px solid #000; background-color: #808080; color: #000">
								<b>OUTSIDE EC</b>
						...
						<tr>
							<td colspan="2" style="text-align:center; font-weight:bold; border:1px solid #000; background-color: #808080; color: #000"> Families </td>
							<td colspan="2" style="text-align:center; font-weight:bold; border:1px solid #000; background-color: #808080; color: #000"> Persons </td>
							<td colspan="2" style="text-align:center; font-weight:bold; border:1px solid #000; background-color: #808080; color: #000"> Families </td>
							<td colspan="2" style="text-align:center; font-weight:bold; border:1px solid #000; background-color: #808080; color: #000"> Persons </td>
							<td colspan="2" style="text-align:center; font-weight:bold; border:1px solid #000; background-color: #808080; color: #000"> Families </td>
							<td colspan="2" style="text-align:center; font-weight:bold; border:1px solid #000; background-color: #808080; color: #000"> Persons </td>
		    		...
		    		<tfoot>
						<tr>
							<td colspan="18" style="text-align:center; font-weight:bold; border:1px solid #000; background-color: #808080; color: #000"> *** NOTHING FOLLOWS ***</td>
						</tr>
						<tr>
		    				<th style="text-align:center; font-weight:lighter" colspan="18"> </th>
		    			</tr>
		    			<tr>
		    				<th style="text-align:center; font-weight:bolder; color: #000" colspan="4">Prepared by: </th>
		    				<th style="text-align:center; font-weight:bolder; color: #000" colspan="5">Noted by: </th>
		    				<th style="text-align:center; font-weight:bolder; color: #000" colspan="9">Approved by: </th>
		    			</tr>
		    			<tr>
		    				<th style="text-align:center; font-weight:lighter" colspan="18"> </th>
		    			</tr>
		    			<tr>
		    				<th style="text-align:center; font-weight:bolder; color: #000" colspan="4" id="spreparedby"></th>
		    				<th style="text-align:center; font-weight:bolder; color: #000" colspan="5" id="srecommendedby"></th>
		    				<th style="text-align:center; font-weight:bolder; color: #000" colspan="9" id="sapprovedby"></th>
		    			</tr>
		    			<tr>
		    				<th style="text-align:center; font-weight:bolder; color: #000" colspan="4" id="spreparedbypos"></th>
		    				<th style="text-align:center; font-weight:bolder; color: #000" colspan="5" id="srecommendedbypos"></th>
		    				<th style="text-align:center; font-weight:bolder; color: #000" colspan="9" id="sapprovedbypos"></th>
		    			</tr>
					</tfoot>
		    	</table>
		    </div>
	  ...
	  <div id="evacuation_stats" class="tab-pane fade">
	  	<div class="col-md-12" style="margin-top:-20px"><label><i class="fa fa-info-circle"></i> Reminders: Double click each entry to update/edit.</label></div>
	    		...
	    		<table style="width:100%;">
		  		...
		  		<table style="width:100%" id="evac_stats">
		  			...
		  			<tfoot>
						...
						<tr>
		    				<th style="text-align:center; font-weight:lighter" colspan="10"> </th>
		    			</tr>
						<tr>
	  ...
	  <div id="evacuation_stats_outside" class="tab-pane fade">
	    ...
	    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="border:1px solid gray;" id="tbl_evacuation_stats_outside">
		    <table style="width:100%;">
	    		<thead>
	    			<tr>
	    				<th colspan="6" style="text-align:center; font-weight:lighter">Department of Social Welfare and Development</th>
	    			</tr>
	    			<tr>
	    				<th colspan="6" style="text-align:center;"><b>DISASTER RESPONSE, OPERATIONS, MONITORING AND INFORMATION CENTER</b></th>
	    			</tr>
	    			<tr>
	    				<th colspan="6" style="text-align:center; font-weight:lighter">Batasan Pambansa Complex, Constitution Hills</th>
	    			</tr>
	    			<tr>
	    				<th colspan="6" style="text-align:center; font-weight:lighter">Quezon City</th>
	    			</tr>
	    			<tr>
	    				<th colspan="6" style="text-align:center; font-weight:lighter"><br></th>
	    			</tr>
	    			<tr>
	    				<th colspan="6" style="text-align:center;"><b>STATUS OF OUTSIDE EVACUATION CENTERS</b></th>
	    			</tr>
	    			<tr>
	    				<th colspan="6" style="text-align:center; font-weight:lighter" id="asofdate_OEC">As of: </th>
	    			</tr>
	    			<tr>
	    				<th colspan="6" style="text-align:center; font-weight:lighter" id="asoftime_OEC">Time: </th>
	    			</tr>
	    			<tr>
	    				<th colspan="6" style="text-align:left; font-weight:lighter">Region:<b> CARAGA </b> </th>
	    			</tr>
	    			<tr>
	    				<th colspan="6" style="text-align:left; font-weight:lighter" id="disastertype_OEC"></th>
	    			</tr>
	    			<tr>
	    				<th colspan="6" style="text-align:left; font-weight:lighter" id="disasterdate_OEC"></th>
	    			</tr>
	    		</thead>
	    		<tbody>
	    		</tbody>
            ...
            <div class="modal-body">
              ...
              <div class="row">
              	...
              	<div class="form-group col-md-12">
              		...
              		<select class="form-control" id="brgylocated_ec">
              			<option value="">-- Select Barangay --</option>
              		</select>
              	</div>
              	<div class="form-group col-md-12">
              	...
              	<div class="form-group col-md-6">
              		...
              		<input type="text" class="form-control" id="ecfamcum">
              	</div>
              	<div class="form-group col-md-6">
              		<label> <i style="color:red">*</i>  Family NOW </label>
              		<input type="text" class="form-control" id="ecfamnow">
              	</div>
              	<div class="form-group col-md-6">
              		<label> <i style="color:red">*</i>  Persons CUM </label>
              		<input type="text" class="form-control" id="ecpercum">
              	</div>
              	<div class="form-group col-md-6">
              		<label> <i style="color:red">*</i>  Persons NOW </label>
              		<input type="text" class="form-control" id="ecpernow">
              	</div>
              	<div class="form-group col-md-12">
              		<label> <i style="color:red">*</i>  Place of Origin (Evacuees) </label>
              		<select class="form-control" id="ecplaceorigin">
              			<option value="">-- Select Barangay --</option>
              		</select>
              	</div>
              	<!-- <div class="form-group col-md-6">
