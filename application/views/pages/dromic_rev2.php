<div class="row">
	<ul class="nav nav-tabs">
	  ...
	  <li class="active"><a data-toggle="tab" class="btn btn-xs btn-success tabpill" href="#home" style="border-radius:0px; color:#272822" id="toexcel1">Form 1 (Main Report - F1)</a></li>
