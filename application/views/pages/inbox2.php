	      ...
	      <div class="x_content">
	        <div class="row">
	        	<ul class="nav nav-tabs">
				  ...
				  <li class="active"><a data-toggle="tab" class="btn btn-xs btn-success tabpill" href="#callout" style="border-radius:0px; color:#272822" id="toexcel1">Callout Type Inbox</a></li>
				  <li><a data-toggle="tab" href="#tabletype" class="btn btn-sm btn-success tabpill" style="border-radius:0px; color:#272822" id="toexcel2">Table Type Inbox</a></li>
				  
				</ul>

			<div class="tab-content">

				<div id="callout" class="tab-pane fade in active">

					<div class="col-sm-12 mail_list_column">
			          	<br>
			          	<center>

				          	<div class="row" style="width: 100%; height: 800px; border: 1px solid gray; overflow: auto">
				          		<br>
				          		<div class="col-md-12" id="divinbox">
					          	</div>
				          	</div>
				...
				<div id="tabletype" class="tab-pane fade">

				          	<div class="row">
				          		<br>
			          				<div class="col-sm-12" id="div_inbox">
						          		<table class="table table-bordered col-sm-12" id="msg_ecstatus">
						          			<thead>
							          				<tr>
							          		...
							          		<table class="table table-bordered col-sm-12" id="msg_castatus">
							          			<thead>
							          				<tr>
